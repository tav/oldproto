// Public Domain (-) 2010-2012 The Espra Authors.
...
public class CajoleitServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		inputType = req.getParameter("type");

		resp.setContentType("text/plain; charset=utf-8");

		if (!Util.isAuthKey(req.getParameter("key"))) {
			badRequest("Invalid auth key.");
			return;
		}
		...
		renderContext = new RenderContext(tokenConsumer).withJson(false);
